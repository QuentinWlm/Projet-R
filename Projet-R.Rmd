...
```{r}
#1. Quel invité vedette s'est joué lui-même dans plusieurs épisodes des Simpson ?
...
```{r}
#2. Quels rôles les Guest Stars ont joué en fonction des saisons ?
...
```{r}
#3. Combien de lignes de dialogue ont les Guest Stars par épisode ?
